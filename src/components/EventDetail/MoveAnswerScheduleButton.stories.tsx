...
export default {
  component: MoveAnswerScheduleButton,
} as Meta;
...
const beforeVoteInitialize = ({ set }: MutableSnapshot) => {
  set(eventState, beforeCommentState);
};

export const beforeVote = () => {
  return (
    <RecoilRoot initializeState={beforeVoteInitialize}>
...
export const afterVote = () => {
  return (
    <RecoilRoot initializeState={afterVoteInitialize}>
      <MoveAnswerScheduleButton />
    </RecoilRoot>
  );
};
